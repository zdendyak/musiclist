  ...
  render() {
    ...
    return (
      <div className="row justify-content-center">
        <div className="col-10 col-sm-7 col-md-5 col-lg-4">
          <p>
            Please enter and confirm a new password below to change the password associated with this email adress.
          </p>
          ...
          <AvForm onValidSubmit={this.handleValidSubmit}>
            <AvGroup>
              ...
              />
              <AvFeedback>Password must be at least eight characters in length</AvFeedback>
            </AvGroup>
