...
export default class ResetPasswordPage extends React.Component {
  ...
  render() {
      ...
      return (
        <div className="row justify-content-center">
          <div className="col-10 col-sm-7 col-md-5 col-lg-4">
            <p>
              An email has been sent to the address you provided containing a link to reset your password. Please click that link to proceed with setting a new password.
            </p>
            <p>
    ...
    return (
      <div className="row justify-content-center">
        <div className="col-10 col-sm-7 col-md-5 col-lg-4">
          <p>If you would like to reset your password, please enter your email here and a link to do so will be sent to the adress you enter</p>
          <AvForm onValidSubmit={this.handleValidSubmit}>
            <AvGroup>
              ...
              />
              <AvFeedback>A valid email is required to reset ypur password</AvFeedback>
            </AvGroup>
